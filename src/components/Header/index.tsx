...
const Header = () => {
  ...
  const scrollToSection = (e, sectionId) => {
    if (pathname !== '/') {
      // Eğer ana sayfada değilsek, varsayılan davranışı engellemiyoruz
      // ve normal bir sayfa geçişi yapıyoruz
      return;
    }
    
    // Ana sayfadaysak, varsayılan davranışı engelliyoruz
    e.preventDefault();
    
    // Zaten ana sayfadaysak, direkt olarak scroll et
  ...
  useEffect(() => {
    if (isClient && pathname === '/') {
      ...
      if (hash) {
        // Sayfa yüklenmeyi bitirdiğinde scroll işlemini gerçekleştir
        setTimeout(() => {
                      ...
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            href={menuItem.path}
                            onClick={(e) => {
                              if (menuItem.path === '/#features') {
                                scrollToSection(e, 'features');
                              } else if (menuItem.path === '/#about') {
